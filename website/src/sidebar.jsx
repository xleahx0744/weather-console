...
export default function Sidebar() {
    ...
    return (
        <nav className={`${settings.theme.sidebar} items-center h-16 flex justify-between p-2 overflow-clip scrollbar-width-0`}>
            ...
            <section className='text-white flex gap-4'>
                <NavLink to='/' className={({ isActive }) =>
                    `items-center leading-10 flex gap-1 p-1 text-xl font-semibold rounded-md ${settings.theme.sidebarPage} hover:border-2 duration-100 hover:border-green-500 ${isActive ? 'border-green-500 bg-gray-700 border-2' : ""}`
                }>
                ...
                <NavLink to='/severe-weather' className={({ isActive }) =>
                    `items-center leading-10 flex gap-1 p-1 text-xl font-semibold rounded-md ${settings.theme.sidebarPage} hover:border-2 duration-100 hover:border-amber-500 ${isActive ? 'border-amber-500 bg-gray-700 border-2' : ""}`
                }>
                ...
                <NavLink to='/risk' className={({ isActive }) =>
                    `items-center leading-10 flex gap-1 p-1 text-xl font-semibold rounded-md ${settings.theme.sidebarPage} hover:border-2 duration-100 hover:border-purple-500 ${isActive ? 'border-purple-500 bg-gray-700 border-2' : ""}`
                }>
                ...
                <NavLink to='/settings' className={({ isActive }) =>
                    `items-center leading-10 flex gap-1 p-1 text-xl font-semibold rounded-md ${settings.theme.sidebarPage} hover:border-2 duration-100 hover:border-gray-500 ${isActive ? 'border-gray-500 bg-gray-700 border-2' : ""}`
                }>
